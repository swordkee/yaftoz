...
class Simple implements \Yaf\Route_Interface
{
     ...
     * @param string $action
     */
    public function __construct(string module, string controller, string action) -> void
    {
    ...
    public function route(<Request_Abstract> request)
    {
        ...
        let module =  isset _GET[this->_module] ? _GET[this->_module] : null;
        
        let controller =  isset _GET[this->_controller] ? _GET[this->_controller] : null;
        
        let action =  isset _GET[this->_action] ? _GET[this->_action] : null;
